    ...
    <div className="bg-slate-950 min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-xl font-bold text-slate-200">Welcome Back Developer</h2>
          <p className="text-slate-400 text-xs mt-1.5 font-medium">Console into your growth scoreboard</p>
        </div>
        ...
        <div className="glass-card p-8 border-slate-800 shadow-2xl relative">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={validating}
              className="w-full glow-btn text-xs py-3 flex items-center justify-center gap-1.5 disabled:opacity-50"
            >
              {validating ? 'Authenticating...' : 'Sign In To Dashboard'} <FiArrowRight />
            </button>
          </form>

          {/* Helper navigation links */}
          <div className="mt-8 text-center text-xs font-semibold text-slate-500 border-t border-slate-900 pt-6">
            New to the growth platform?{' '}
